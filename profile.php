...
<head>
    ...
    <title> Profile | <?php echo $webName.' - '.$webDesc; ?> </title>
...
<body>
	...
	<div class="rowspan center navOffset">
		...
		<div class="grid column-3 no-border inline-table">
		<b class="color-grey"> Update your profile </b>
			<form method="post" action="<?php echo htmlspecialchars('update.php');?>">
				<input class="display-hide" type="text" name="form" value="profile" required/>
				<input class="display-hide" type="text" name="bot" value="" />
				<input type="text" name="firstname" placeholder="Firstname" value="<?php echo $fetchuser['Fname']; ?>" required/>
				<input type="text" name="lastname" placeholder="Lastname" value="<?php echo $fetchuser['Lname']; ?>" required/><br/>

				<b>Gender :</b> &nbsp; <input type="text" placeholder="Lastname" value="<?php echo $fetchuser['gender']; ?>" style="width:180px;" disabled/>
				<input type="email" name="email" value="<?php echo $fetchuser['email']; ?>" placeholder="Email" required/>
				<input type="text" name="telephone" placeholder="Telephone" value="<?php echo $fetchuser['telephone']; ?>" required/>
				<textarea name="address" placeholder="Address" style="width:90%;min-height:80px;border:1px solid silver;padding:4%;border-radius:3px;font-family:arial;font-size:14px;" required><?php echo $fetchuser['address']; ?></textarea>
            ...
            <br/>
            <form method="post" action="<?php echo htmlspecialchars('update.php');?>">
                <input class="display-hide" type="text" name="form" value="chngpass" required/>
                Change your password
                <input type="password" name="chngpass" placeholder="Change your password" required/><br/>
