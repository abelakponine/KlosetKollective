...
<body>
    ...
    <script type="text/javascript">
        function doSearch() {
            if($('input[type=search]').val().length > 0){
                ...
                $('#darkLayer').show();
                $('#searchLoader').html('<span class="fas fa-spinner fa-spin relative navOffsetx3" style="font-size:2.5em;color:#adadad;"></span>');
                $('#searchLoader').load('category.php?products=New+in&class=viewall&genre=women&search='+$('input[type=search]').val().replace(' ','+')+' container');
                $('.checkout').load('category.php?products=New+in&class=viewall&genre=women&search='+$('input[type=search]').val().replace('%20',' ')+' checkout');
                ...
                "></button>
                    ...
                    <div class="grid column-2 no-border no-margin no-padding rowspan">
                        <div class="grid column-2 no-border no-padding">
                            <a href="index.php"><button class="active"> WOMEN </button></a>
                        </div>
                        <div class="grid column-2 no-border no-padding">
    ...
    <section>
        <?php
            ...
            $latestProd = "SELECT * FROM products WHERE prod_genre = 'women' ORDER BY `SN` DESC";
        ...
        <div class="rowspan center">
                <div id="imgAd" class="grid column-2 no-border center" style="width:unset;">
                    <div class="overflow-x-hide full-width center">
                        <a href="#"><img src="images/<?php echo $web_res['shoptheeditLeftImg'];?>" style="width:auto;height:600px;"></a>
                            <div class="defaultBtn no-margin no-padding full-width center" style="background:white;padding:3% 0;font-size:24px;line-height:36px;border-radius:0;"> <?php echo $web_res['shoptheeditLeftMainText'];?> </div>
                            <small><h3 style="font-weight:normal;"> <?php echo $web_res['shoptheeditLeftSubText'];?> </h3></small>
                ...
                <div id="imgAd" class="grid column-2 no-border center" style="width:unset;">
                    <div class="overflow-x-hide full-width center">
                        <a href="#"><img src="images/<?php echo $web_res['shoptheeditRightImg'];?>" style="width:auto;height:600px;"></a>
                            <div class="defaultBtn no-margin no-padding full-width center" style="background:white;padding:3% 0;font-size:24px;line-height:36px;border-radius:0;"> <?php echo $web_res['shoptheeditRightMainText'];?> </div>
                            <small><h3 style="font-weight:normal;"> <?php echo $web_res['shoptheeditRightSubText'];?> </h3></small>
                            <a href="#"><button class="defaultBtnn no-margin" style="width:170px;background:white;padding:3% 0;color:#505050;font-size:20px;line-height:21px;border:2px solid #505050;border-radius:0;"> SHOP THE EDIT </button></a>
                    </div>
                </div>
        </div>
        ...
        <div class="rowspan center">
                <div id="imgAd" class="grid column-2 no-border center" style="width:unset;">
                    <div class="overflow-x-hide full-width center">
                        <a href="category.php?products=New+in&class=viewall&genre=women&search=<?php echo explode(' ', $getlprod[0]['prod_price'])[1];?>"><img src="products/images/<?php echo $getlprod[0]['prod_attach'];?>" style="width:auto;height:600px;"></a>
                            ...
                            <small><h3 style="font-weight:normal;text-transform:capitalize;"> <?php echo $getlprod[0]['prod_name'];?> </h3></small>
                            <a href="category.php?products=New+in&class=viewall&genre=women&search=<?php echo explode(' ', $getlprod[0]['prod_price'])[1];?>"><button class="defaultBtnn no-margin" style="width:170px;background:white;padding:3% 0;color:#505050;font-size:20px;line-height:21px;border:2px solid #505050;border-radius:0;"> SHOP THE EDIT </button></a>
                    </div>
                </div>
                <div id="imgAd" class="grid column-2 no-border center" style="width:unset;">
                    <div class="overflow-x-hide full-width center">
                        <a href="category.php?products=New+in&class=viewall&genre=women&search=<?php echo explode(' ', $getlprod[1]['prod_price'])[1];?>"><img src="products/images/<?php echo $getlprod[1]['prod_attach'];?>" style="width:auto;height:600px;"></a>
                            ...
                            <small><h3 style="font-weight:normal;text-transform:capitalize;"> <?php echo $getlprod[1]['prod_desc'];?> </h3></small>
                            <a href="category.php?products=New+in&class=viewall&genre=women&search=<?php echo explode(' ', $getlprod[1]['prod_price'])[1];?>"><button class="defaultBtnn no-margin" style="width:170px;background:white;padding:3% 0;color:#505050;font-size:20px;line-height:21px;border:2px solid #505050;border-radius:0;"> SHOP THE EDIT </button></a>
                    </div>
                </div>
        </div>
    ...
    <div class="grid column-1 no-border float-left" style="background:#e8b231;">
            ...
            <div class="rowspan">
                ...
                <div class="grid column-5 no-border no-padding" style="width: 170px;">
                    <div class="full-width overflow-x-hide thumbnail" style="font-size:0px;">    
                        <img src="images/<?php echo $web_res['shop_bycat_img1'];?>" style="width:auto;height:250px;position:relative;left:;-5%;"/>
                        <button class="defaultBtn inline-table no-margin" style="width:170px;background:white;padding:3% 0;font-size:20px;line-height:21px;border-radius:0;"> <?php echo $web_res['shop_bycat1'];?> </button>
                    </div>
                </div>
                <div class="grid column-5 no-border no-padding" style="width: 170px;">
                    <div class="full-width overflow-x-hide thumbnail" style="font-size:0px;">    
                        <img src="images/<?php echo $web_res['shop_bycat_img2'];?>" style="width:auto;height:250px;position:relative;left:;-5%;"/>
                        <button class="defaultBtn inline-table no-margin" style="width:170px;background:white;padding:3% 0;font-size:20px;line-height:21px;border-radius:0;"> <?php echo $web_res['shop_bycat2'];?> </button>
                    </div>
                </div>
                <div class="grid column-5 no-border no-padding" style="width: 170px;">
                    <div class="full-width overflow-x-hide thumbnail" style="font-size:0px;">    
                        <img src="images/<?php echo $web_res['shop_bycat_img3'];?>" style="width:auto;height:250px;position:relative;left:;-5%;"/>
                        <button class="defaultBtn inline-table no-margin" style="width:170px;background:white;padding:3% 0;font-size:20px;line-height:21px;border-radius:0;"> <?php echo $web_res['shop_bycat3'];?> </button>
                    </div>
                </div>
                <div class="grid column-5 no-border no-padding" style="width: 170px;">
                    <div class="full-width overflow-x-hide thumbnail" style="font-size:0px;">    
                        <img src="images/<?php echo $web_res['shop_bycat_img4'];?>" style="width:auto;height:250px;position:relative;left:;-5%;"/>
                        <button class="defaultBtn inline-table no-margin" style="width:170px;background:white;padding:3% 0;font-size:20px;line-height:21px;border-radius:0;"> <?php echo $web_res['shop_bycat4'];?> </button>
                    </div>
                </div>
                <div class="grid column-5 no-border no-padding" style="width: 170px;">
                    <div class="full-width overflow-x-hide thumbnail" style="font-size:0px;">    
                        <img src="images/<?php echo $web_res['shop_bycat_img5'];?>" style="width:auto;height:250px;position:relative;left:;-5%;"/>
                        <button class="defaultBtn inline-table no-margin" style="width:170px;background:white;padding:3% 0;font-size:20px;line-height:21px;border-radius:0;"> <?php echo $web_res['shop_bycat5'];?> </button>
                    </div>
                </div>
